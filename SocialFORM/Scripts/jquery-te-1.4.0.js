...
(function($){		
	$.fn.jqte = function(options){
        ...
        addParams('format', 'formats', '', '', true); // text format button  --> no hotkey
		addParams('fsize','fSize','','',true); // font size button --> no hotkey
		addParams('color','colors','','', true); // text color button  --> no hotkey
		...
		addParams('outdent','outdent','%',["blockquote"],true); // outdent --> ctrl + left arrow
        addParams('indent', 'indent', '\'', ["blockquote"], true); // indent --> ctrl + right arrow
        addParams('left', 'justifyLeft', '', '', true); // justify Left --> no hotkey
        addParams('center', 'justifyCenter', '', '', true); // justify center --> no hotkey
		addParams('right','justifyRight','','',true); // justify right --> no hotkey
